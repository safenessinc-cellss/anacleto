      ...
      <div className="text-center space-y-8 max-w-md px-6">
        ...
        <div className="relative w-64 h-72 mx-auto bg-slate-800 rounded-xl shadow-2xl shadow-black/50 border-2 border-slate-600 overflow-hidden">
          ...
          <div className="absolute inset-2 border-4 border-slate-500 rounded-lg bg-slate-900">
            ...
            {/* Marco interior - aparece en paso 1 */}
            <div className={`absolute top-1/2 left-0 w-full h-3 bg-gradient-to-b from-slate-500 to-slate-600 transform -translate-y-1/2 transition-all duration-700 ${step >= 1 ? 'opacity-100' : 'opacity-0'}`}></div>
            <div className={`absolute left-1/2 top-0 w-3 h-full bg-gradient-to-r from-slate-500 to-slate-600 transform -translate-x-1/2 transition-all duration-700 ${step >= 1 ? 'opacity-100' : 'opacity-0'}`}></div>
            ...
            <div className={`absolute inset-[18px] transition-all duration-1000 ${showGlass ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
              <div className="w-full h-full bg-gradient-to-br from-cyan-400/20 to-blue-500/30 rounded-md backdrop-blur-sm border border-white/20">
            ...
            {showScrews && (
              <>
                <div className="absolute top-6 left-6 w-2 h-2 rounded-full bg-amber-500 shadow-md animate-pulse"></div>
                <div className="absolute top-6 right-6 w-2 h-2 rounded-full bg-amber-500 shadow-md animate-pulse"></div>
                <div className="absolute bottom-6 left-6 w-2 h-2 rounded-full bg-amber-500 shadow-md animate-pulse"></div>
                <div className="absolute bottom-6 right-6 w-2 h-2 rounded-full bg-amber-500 shadow-md animate-pulse"></div>
              </>
            )}
            ...
            {showHandle && (
              <div className="absolute right-8 top-1/2 transform -translate-y-1/2 animate-slide-in">
                <div className="w-8 h-3 bg-gradient-to-r from-slate-300 to-slate-400 rounded-full shadow-md"></div>
                <div className="w-2 h-6 bg-slate-400 rounded-full mx-auto mt-1"></div>
              </div>
            )}
          </div>
        ...
        <div className="space-y-3">
          <div className="px-4 py-2 bg-amber-500/10 border border-amber-500/30 rounded-full inline-block mx-auto">
          ...
          <div className="w-full max-w-xs mx-auto">
            <div className="w-full bg-slate-700 rounded-full h-1.5 overflow-hidden">
              <div 
                className="bg-gradient-to-r from-amber-500 to-amber-400 h-full transition-all duration-500 ease-out rounded-full"
